...
const AdventureOnlinePlayersModule: React.FC<{
  props: any,
  onClose: () => void,
  ...
  const close = () => {
    ...
    document.getElementById('adventure-online-players-mask')?.classList.add('hide');
    document.getElementById('adventure-online-players-module')?.classList.add('hide');
    setTimeout(()=>{
      onClose()
    }, 600)
  }
  ...
  return <div className={["mask  adventure-online-players-mask"].join(" ")} id="adventure-online-players-mask" onClick={close}>
    <div className={["adventure-online-players-module", props.from].join(" ")} id="adventure-online-players-module" onClick={onClick}>
      <div className="head">
...
export default AdventureOnlinePlayersModule;
